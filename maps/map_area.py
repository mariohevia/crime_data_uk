...
if st.session_state["selected_location_area"]:
    ...
    st.session_state["filtered_crime_data_area"] = add_pills_filter_df(st.session_state["crime_data_area"])
...
if st.session_state["selected_location_area"]:
    add_area_plot_crime_statistics(st.session_state["filtered_crime_data_area"])
    add_bar_plot_crime_statistics(st.session_state["filtered_crime_data_area"])
else:
